...
gulp.task('webpack', function(callback){
    ...
    let options = {
        ...
        output: {
            ...
            publicPath: (isDevelopment ? '/tiu/build/js/' : '/html/build/js/'),
            libraryTarget: 'var',
            library: "Main",
            filename: "[name].js"
        },
...
gulp.task('jsdoc', function (cb) {
    ...
    return gulp.src(['src/js/**/*.js', '!src/js/vendor/*.js', '!src/js/components/rd-material-tabs.js']).pipe(jsdoc(config, cb));
});
